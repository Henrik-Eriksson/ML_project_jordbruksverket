...
#Counts occurrences of each "groda" in the dataset, saves the result to a JSON file, and visualizes it with a bar chart.
...
with open("result/groda_counts.json", "w", encoding="utf-8") as outfile:
